...
while (opcaoUsuario != "0")
{
    switch (opcaoUsuario)
    {
        ...
        case "3":
            ...
            dividirValor(double.Parse(Console.ReadLine()));
        ...
        case "4":
            ...
            multiplicarValor(double.Parse(Console.ReadLine()));
...
double dividirValor(double valor)
{
    ...
    try
    {
        resultadoDivisao = pegarResultadoDaUltimaOperacaoMatematica() / valor;
        definirResultadoDaUltimaOperacaoMatematica(resultadoDivisao);
        return resultadoDivisao;
    }

    catch (Exception erro) when (valor == 0)
    {
